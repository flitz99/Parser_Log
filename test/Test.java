/****************************************************************************
	IL testing è stato realizzato dal tem testing del gruppo T4
	formato da Simone Baroni e Jacopo Vecchi.
****************************************************************************/
...
ublic class JsonReaderTest {

    @Test
    void readAllLogFile() {
        /**
         * Il test di readAllLogFile è
         * già stato fatto in un altro
         * file ed è stato appurato che
         * ci vuole un controllo sul valore
         * null
         */
    }
